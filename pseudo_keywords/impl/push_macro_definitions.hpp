...
#pragma push_macro( "$_with_helper" )
#pragma push_macro( "$with" )
#pragma push_macro( "$_with_var_helper" )
#pragma push_macro( "$with_var" )
#pragma push_macro( "$_with_let_helper" )
#pragma push_macro( "$with_let" )
